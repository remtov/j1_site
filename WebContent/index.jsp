...
<body id="page-top">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav">
				<li class="nav-item"><a class="nav-link js-scroll-trigger"
					href="#about">소개</a></li>
				<li class="nav-item"><a class="nav-link js-scroll-trigger"
					href="#experience">경력</a></li>
				<li class="nav-item"><a class="nav-link js-scroll-trigger"
					href="#education">학력</a></li>
				<li class="nav-item"><a class="nav-link js-scroll-trigger"
					href="#skills">기술</a></li>
				<li class="nav-item"><a class="nav-link js-scroll-trigger"
					href="#interests">포트폴리오</a></li>
				<li class="nav-item"><a class="nav-link js-scroll-trigger"
					href="#awards">기타활동</a></li>
			</ul>
		</div>
	</nav>
	...
	<div class="container-fluid p-0">
		...
		<section class="resume-section p-3 p-lg-5 d-flex align-items-center"
			...
			<div class="w-100">
				<h1 class="mb-0">
					김 <span class="text-primary">현구</span>
				</h1>
				...
				<div class="social-icons">
					...
					</a> <a href="https://github.com/remtov" target='_blank'> <i
						class="fab fa-github"></i>
					</a> <a href="https://twitter.com/remnanttov" target='_blank'> <i
						class="fab fa-twitter"></i>
					</a> <a href="https://www.facebook.com/remnanttov" target='_blank'>
						<i class="fab fa-facebook-f"></i>
					</a> <a href="https://j1ayone.blogspot.com/" target='_blank'> <i
		...
		<section
			...
			<div class="w-100">
				...
				<div
					...
					<div class="resume-date text-md-right">
						<span class="text-primary">2008.02 - 2008.12</span>
					</div>
				</div>
			</div>
		</section>
		...
		<section class="resume-section p-3 p-lg-5 d-flex align-items-center"
			...
			<div class="w-100">
				...
				<div
					class="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
					<div class="resume-content">
						<h3 class="mb-0">인하공업전문대학</h3>
						<div class="subheading mb-3">공예디자인</div>
						<div>금속,도자,목공예 및 그래픽디자인,캐드 등</div>
						<p>3.64/4.5</p>
					</div>
					<div class="resume-date text-md-right">
						<span class="text-primary">2005.3 - 2009.2</span>
					</div>
				</div>
				...
				<div
					...
					<div class="resume-content">
						<h3 class="mb-0">인천디자인고등학교</h3>
						<div class="subheading mb-3">시각정보디자인</div>
						<div>정보기술기초, 그래픽디자인, 기초제도, 광고,조형, 색채,시각디자인 등</div>
						<p>40.8등/106~108명</p>
					</div>
					<div class="resume-date text-md-right">
						<span class="text-primary">2002.2 - 2005.2</span>
					</div>
				</div>
	...
	<div style='float: right;'>v20200401</div>
